...
{
    public class IntermediateGuitFactory : Creator.GuitarFactory
    {
        private int _guitarPrice;
        private int _avgMaintenance;

        public IntermediateGuitFactory(int guitarPrice, int avgMaintenance)
        {
        ...
        {
            return new IntermediateGuitar(_guitarPrice, _avgMaintenance);
        }
    }
}
